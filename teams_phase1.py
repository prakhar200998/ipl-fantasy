"""Phase 1 (pre-mid-season-auction) rosters — frozen archive.

Source of truth for matches dated before PHASE2_CUTOFF_DATE. Do not edit.
"""
...
def get_captain_vc_phase1() -> dict:
    """Captain/VC map for Phase 1 — used when re-scoring pre-cutoff matches."""
    result = {}
    for team_data in TEAMS_PHASE1.values():
